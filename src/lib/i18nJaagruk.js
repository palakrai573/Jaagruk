...
const AR = {
  ...
  site_marker_label: { en: 'Marker name', hi: 'मार्कर का नाम', sat: 'ᱢᱟᱨᱠᱚᱨ ᱧᱩᱛᱩᱢ', bn: 'মার্কারের নাম', or: 'ମାର୍କରର ନାମ', ur: 'مارکر کا نام' },
  site_delete_zone: { en: 'Delete zone', hi: 'ज़ोन हटाएं', bn: 'জোন মুছুন', or: 'ଜୋନ ଡିଲିଟ କରନ୍ତୁ', ur: 'زون حذف کریں' },
  site_delete_anchor: { en: 'Delete marker', hi: 'मार्कर हटाएं', sat: 'ᱢᱟᱨᱠᱚᱨ ᱚᱜᱟᱲ ᱢᱮ', bn: 'মার্কার মুছুন', or: 'ମାର୍କର ଡିଲିଟ କରନ୍ତୁ', ur: 'مارکر حذف کریں' },
...
const CONSOLE = {
  ...
  set_endpoint_label: { en: 'Upload endpoint URL', hi: 'अपलोड एंडपॉइंट URL', sat: 'ᱟᱯᱞᱳᱰ ᱮᱱᱰᱯᱚᱭᱱᱴ URL', bn: 'আপলোড এন্ডপয়েন্ট URL', or: 'ଅପଲୋଡ ଏଣ୍ଡପଏଣ୍ଟ URL', ur: 'اپ لوڈ اینڈ پوائنٹ URL' },
